...
ATTENTION_CONFIGS = {
    "single_head": {"num_heads": 1, "key_dim": 64, "dropout": 0.1},
    "multi_head": {"num_heads": 4, "key_dim": 64, "dropout": 0.1},
    "temporal": {"num_heads": 2, "key_dim": 32, "dropout": 0.2, "temporal_window": 6},
}

# Weather feature names and descriptions
WEATHER_FEATURES = {
    "temperature": {"index": 0, "unit": "°C", "description": "Ambient temperature"},
    "humidity": {"index": 1, "unit": "%", "description": "Relative humidity"},
}

# Clustering algorithm specific parameters
CLUSTERING_PARAMS = {
    "sax_kmeans": {"word_size": 24, "alphabet_size": 20, "max_iterations": 100},
    "two_stage_kmeans": {"k_consumption": 3, "k_peaktime": 2, "dx": 0.25},
    "dec": {"alpha": 1.0, "update_interval": 1, "tolerance": 0.001},
}
