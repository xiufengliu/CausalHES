...
class TestPecanStreetGenerator:
    ...
    def test_small_dataset_generation(self):
        ...
        try:
            ...
            load_profiles, weather_data, labels, metadata = (
                generator.generate_pecan_street_dataset(
            ...
            assert np.all(weather_data >= 0) and np.all(
                weather_data <= 1
            )  # Normalized weather
    ...
    def test_archetype_distribution(self):
        ...
        try:
            ...
            load_profiles, weather_data, labels, metadata = (
                generator.generate_pecan_street_dataset(
                    n_homes=n_homes, n_days=1, start_date="2022-01-01"
                )
            )
...
class TestDataIntegrity:
    ...
    def test_temporal_consistency(self):
        ...
        assert np.argmin(pattern) == 17  # Trough around hour 17-18 (3π/2)
